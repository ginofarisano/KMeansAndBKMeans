...
public class Bisec {
	...
	private int numbersOfDocuments;
	private int topX;
	private DiscanceStrategy distance;
	

	public void firstStep(String datafile,int iterations, DiscanceStrategy distance, int numbersOfDocuments, int topX) throws IOException {
	...
	public void otherStep(int round) throws IOException {
		...
		for(int i=0;i<numberOfIterations;i++){
			...
			c1.calculateCentroid(topX);
			c2.calculateCentroid(topX);
