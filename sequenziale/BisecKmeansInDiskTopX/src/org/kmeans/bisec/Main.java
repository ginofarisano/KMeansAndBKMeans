...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println ("Enter the numbers of centroid to mantain: ");
		try {
			
			topx = Integer.parseInt(myConsole.readLine ());
		...
		bisec.firstStep(fileName,iterations,strategy,numbersOfDocuments,topx);
